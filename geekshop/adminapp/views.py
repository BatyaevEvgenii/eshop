...
def product_create(request, pk):
    ...
    if request.method == 'POST':
        ...
        # добавляя новый продукт, заполняем форму начальными данными
        # в initial передаем словарь
...
def product_update(request, pk):
    ...
    content = {
        'title': title,
        'update_form': edit_form,
        # всегда есть объект категории в продукте
